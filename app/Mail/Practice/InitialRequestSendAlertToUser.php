...
class InitialRequestSendAlertToUser extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('email.Practice.initial-practice-send-alert-user',['initialPractice'=>$this->initialPractice])
        ->from($address, $name)
