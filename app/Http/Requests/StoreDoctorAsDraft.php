...
class StoreDoctorAsDraft extends FormRequest
{
    /**
    ...
    {
        return [
            'suffix' => ['sometimes','required' , Rule::in(['Miss', 'Mrs', 'Ms', 'Mr'])],
            'first_name' => ['sometimes', 'required' , 'max:29'],
            'last_name' => ['sometimes', 'required' , 'max:29'],

            'primary_email' => ['sometimes', 'required', 'string', 'email', 'max:254',
                Rule::when($request->has('doctor_id'), Rule::unique('doctors')->ignore($request->doctor_id)),
                Rule::when(!$request->has('doctor_id'), 'unique:doctors'),
            ],

            'secondary_email' => ['sometimes', 'required', 'string', 'email', 'max:254'],
            'gender' => ['sometimes', 'required' ,  Rule::in(['Male', 'Female', 'Transgender', 'Prefer not to say', 'Other'])],
            'dob' => ['sometimes', 'required', 'date'],
            'country_code_primary_phone_number' => ['sometimes', 'required' , 'max:9'],
            'primary_phone_number' => ['sometimes', 'required' , 'max:14'],

            'license_number' => ['sometimes', 'required', 'max:49',
            ...
            'current_country_id' => [ 'sometimes', 'required' , 'numeric'],
            'current_state_id' => [ 'sometimes', 'required' , 'numeric'],
            'current_city_id' => [ 'sometimes', 'required' , 'numeric'],
            'home_town_country_id' => [ 'sometimes', 'required' , 'numeric'],
            'home_town_state_id' => [ 'sometimes', 'required' , 'numeric'],
            'home_town_city_id' => [ 'sometimes', 'required' , 'numeric'],
            'current_address_1' => [ 'sometimes', 'required' , 'max:254'],
            'current_zip_code' => [ 'sometimes', 'required' , 'max:14'],
            'home_town_address_1' => [ 'sometimes', 'required' , 'max:254'],
            'home_town_zip_code' => [ 'sometimes', 'required' , 'max:14'],
            'specialization_id' => [ 'sometimes', 'required' ],
//            'license_photo_url' => ['sometimes', 'required', 'mimes:doc,pdf,docx,jpeg,jpg,png'],
//            'passport_photo_url' => ['sometimes', 'required', 'mimes:doc,pdf,docx,jpeg,jpg,png'],
//            'emirate_photo_url' => ['sometimes', 'required', 'mimes:doc,pdf,docx,jpeg,jpg,png'],
            // COMMENTED FOR NOW
//            'file_path' => ['sometimes', 'required'],
//            'file_path.*' => ['sometimes', 'mimes:doc,pdf,docx,jpeg,jpg,png'],  // 10240 = max 10 MB
//            'profile_photo_url' => ['sometimes', 'mimes:jpeg,jpg,png'],
    ...
    public function messages()
    {
        $return = [
            ...
            'country_code_primary_phone_number.required' => 'Please select a country code for phone number',
            ...
            // 'emirate_id.required' => 'Please enter emirate id',
            // 'emirate_id.unique' => 'Entered emirate id is already in use',
