...
class EPrescriptionGenerated implements ShouldBroadcast
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    private $appointment, $notification, $unread_notifications_count, $total_notifications;
    ...
    {
        return new Channel('e-prescription-generated');
    }

    public function broadcastAs(): string
    {
        return 'EPrescriptionGenerated'.'-'.$this->appointment->patient->patient_key;
    }
