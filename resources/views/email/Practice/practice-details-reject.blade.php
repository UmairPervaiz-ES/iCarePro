...
<body  class="body">
  ...
  <div class="section">
    <div class="top">
     ...
     <div class="heading">Practice request rejected!
      </div>
    </div>
    <div class="inner-section">
      <div class="title">Hi <strong> {{ucfirst($practice->initialPractice['first_name'])}} 
        {{ucfirst($practice->initialPractice['middle_name'])}} {{ucfirst($practice->initialPractice['last_name'])}}</strong>,</div>
      ...
      <div class="row">
        <a  href="{{$practiceRegistration}}" target="_blank"  class="action-btn">Visit website</a>
