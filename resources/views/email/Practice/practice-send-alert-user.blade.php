...
<body  class="body">
  ...
  <div class="section">
    <div class="top">
     ...
     <div class="heading"> Practice registration request sent successfully!
      </div>
    </div>
    <div class="inner-section">
      <div class="title">Hi <strong> {{ucfirst($initialPractice['first_name'])}}
         {{ucfirst($initialPractice['middle_name'])}} 
         {{ucfirst($initialPractice['last_name'])}}
        </strong>,</div>
      <div class="description">
        Thank you for submitting the registration form. Your request has been received and currently being under review by our team. You will be notified via email regarding the acceptance/rejection of your request.
      </div>
