  ...
  <div class="section">
    ...
    <div class="inner-section">
      ...
      <div class="description">
        ...
        {{$practice->initialPractice['practice_name']}}. This email contains the login details for your account. Click the link to complete the registration.
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-10 value">{{$doctor['primary_email']}}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <a  href="{{$doctorLogin}}"  target="_blank"  class="action-btn">Login to your account</a>
