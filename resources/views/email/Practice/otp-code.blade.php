...
<body  class="body">
  ...
  <div class="section">
    <div class="top">
     ...
     <div class="heading">Verify Your Email Address !
      </div>
    </div>
    <div class="inner-section">
      <div class="title">Hi <strong></strong>,</div>
      <div class="description">Enter the below code in order to reset your email.

      </div>

      <div class="row">
        <span  class="otp-btn" >{{$details['otp']}}</span>

      </div>  

      <div class="row">
        <div class="action-heading">If you did not generate the request then ignore this email.
      </div>
      </div>

      <div class="row">
        <a  href="" target="_blank"  class="action-btn">Verify email address
        </a>
