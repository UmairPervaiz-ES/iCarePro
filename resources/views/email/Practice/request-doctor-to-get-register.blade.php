...
<div class="section">
    ...
    <div class="inner-section">
        <div class="title">Hi <strong>{{ucfirst($doctorPractice->doctor->first_name)}} {{ucfirst($doctorPractice->doctor->middle_name)}} {{ucfirst($doctorPractice->doctor->last_name)}} </strong>,</div>
        <div class="description">
            Practice with name {{$doctorPractice->practice->initialPractice->practice_name}}
            is requesting you to register as a doctor in his practice. <br>
            Login to your account to accept or reject the request.
        </div>


        <div class="row">
            <a  href="{{$doctorRequestRoute}}"  target="_blank"  class="action-btn">Login</a>
