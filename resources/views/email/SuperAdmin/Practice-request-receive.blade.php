...
<body  class="body">
  ...
  <div class="section">
    <div class="top">
     ...
     <div class="heading"> Practice registration request received successfully!
      </div>
    </div>
    <div class="inner-section">
      <div class="title">Hi <strong> Admin</strong>,</div>
      <div class="description">You have received a practice registration form for review and approval. </div>
      <div class="row">
