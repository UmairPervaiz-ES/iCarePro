...
<div class="section">
    ...
    <div class="inner-section">
        <div class="title">Hi <strong>{{ucfirst($user['first_name'])}} {{ucfirst($user['middle_name'])}} {{ucfirst($user['last_name'])}} </strong>,</div>
        <div class="description">
            @if(!isset($password) && $password == null)
                Your account has been successfully registered by the
                {{$user->practice->initialPractice['practice_name']}}.
            @endif
            @if(isset($password) && $password != null)
                Your login details for your iCarePro account.
            @endif
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10 value">{{$user['email']}}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <a href="{{$staffLogin}}" target="_blank"  class="action-btn">Login to your account</a>
