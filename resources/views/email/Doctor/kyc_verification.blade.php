...
<body  class="body">
  ...
  <div class="section">
    <div class="top">
     ...
     <div class="heading">KYC Verification !
      </div>
    </div>
    <div class="inner-section">
      ...
      <div class="description">
        Your registration is completed. Please verify your identity by clicking below.
      </div>
      ...
      <div class="row">
        <a  href="{{$verification_url}}" target="_blank"  class="action-btn">Verify KYC</a>
